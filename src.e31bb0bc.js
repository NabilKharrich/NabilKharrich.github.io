...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"../lib/spring.js":[function(require,module,exports) {
"use strict";
...
class Spring {
  ...
  render(resolve) {
    ...
    this.values.forEach(value => {
      const hooke = -this.options.stiffness * (value.location - value.target) / this.options.mass;
      const dampening = -this.options.dampening * value.velocity;
      value.acceleration += hooke;
      value.acceleration += dampening;
      ...
      value.resolved = Math.abs(value.location - value.target) < this.options.precision ? true : false;
    });
  ...
  updateConfig(newEntries) {
    Object.keys(newEntries).forEach(key => {
      this.options[key] = this.options.hasOwnProperty(key) && newEntries[key];
    });
  }
...
a();
},{"gsap":"../node_modules/gsap/index.js","./spring":"../lib/spring.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _lib = _interopRequireDefault(require("../lib"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"../lib":"../lib/index.js"}],"../../../.nvm/versions/node/v10.24.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
